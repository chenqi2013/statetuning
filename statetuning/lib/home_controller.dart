...
class HomeController extends GetxController {
  ...
  // --- Sidebar: 0=训练 1=蒸馏 ---
  final sidebarIndex = 0.obs;
  // 蒸馏子 tab: 0=创建任务 1=任务队列 2=实时监控 3=数据统计 4=数据导出 5=生成器管理 6=LLM服务商
  final distillationTabIndex = 0.obs;
  ...
  void setSidebarIndex(int index) => sidebarIndex.value = index;

  void setDistillationTabIndex(int index) => distillationTabIndex.value = index;
